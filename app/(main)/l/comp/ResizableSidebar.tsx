...
export default function ResizableSidebar({
        ...
        return (
            <div className="relative">
                <button
                    ...
                    className="fixed top-4 right-4 z-30 dark:bg-gray-800 bg-neutral-100 hover:bg-gray-700 text-white p-2 rounded-lg shadow-lg transition-all duration-200 border border-gray-600"
                    title="Open sidebar"
                >
                    <svg
                        width="16"
    ...
    return (
        <div
            className={`relative bg-gray-100 text-white  flex-shrink-0 ${className}`}
